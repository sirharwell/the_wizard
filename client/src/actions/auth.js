...
export const registerUser = ( name, gamertag, email, password, passwordConfirmation, history) => {
  return dispatch => {
    axios.post('/api/auth', { name, gamertag, email, password, password_confirmation: passwordConfirmation })
      .then(res => {
